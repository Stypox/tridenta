...
bundle exec fastlane deploy signing_store_file:$signing_store_file signing_store_password:$signing_store_password signing_key_alias:$signing_key_alias signing_key_password:$signing_key_password play_store_json_key:$play_store_json_key
